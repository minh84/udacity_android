...
public class NotificationUtils {
    ...
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 5555;
    /**
    ...
    //      TODO (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action drinkReminderAction = new NotificationCompat.Action(R.drawable.ic_local_drink_black_24px,
                "I did it!",
                pendingIntent);
