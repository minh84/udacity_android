...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        Intent increaseWaterCount = new Intent(this, WaterReminderIntentService.class);
        // Done (16) Set the action of the intent to ACTION_INCREMENT_WATER_COUNT
        increaseWaterCount.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        // Done (17) Call startService and pass the explicit intent you just created
        startService(increaseWaterCount);
    }
