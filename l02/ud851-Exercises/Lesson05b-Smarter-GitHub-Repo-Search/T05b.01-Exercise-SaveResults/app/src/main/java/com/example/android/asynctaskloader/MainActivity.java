...
public class MainActivity extends AppCompatActivity {
    ...
    private final static String RESULT_URL_KEY = "json_result";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (savedInstanceState.containsKey(RESULT_URL_KEY)) {
                mSearchResultsTextView.setText(savedInstanceState.getString(RESULT_URL_KEY));
            }
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(RESULT_URL_KEY, mSearchResultsTextView.getText().toString());
    }
