...
//      Done (13) Find each of the TextViews by ID
        ...
        mDesc = (TextView) findViewById(R.id.tv_weather_desc);
        mHigh = (TextView) findViewById(R.id.tv_high_temp);
        mLow = (TextView) findViewById(R.id.tv_low_temp);
        mHumid = (TextView) findViewById(R.id.tv_humidity);
        mWin = (TextView) findViewById(R.id.tv_wind_speed);
        mPres = (TextView) findViewById(R.id.tv_pressure);
...
//      Done (33) Store a forecast summary in mForecastSummary
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        mHumid.setText(getString(R.string.format_humidity, humid));

        float pressure = data.getFloat(INDEX_WEATHER_PRESSURE);
        mPres.setText(getString(R.string.format_pressure, pressure));

        mForecastSummary = String.format("%s - %s - %s/%s", dateText, desc, highString, lowString);
    }
